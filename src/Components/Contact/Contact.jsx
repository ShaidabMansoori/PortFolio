...
function Contact() {
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "45551639-7ca2-40cc-9e27-03ca85b3e2dc");
  ...
  return (
    <div className="contact">
      <div className="contact-title">
        <h1>Get in touch</h1>
        <img src={theme_pattern} alt="theme_image" />
      </div>
      <div className="contact-section">
        <div className="contact-left">
          <h1>Let's Talk</h1>
          <p>
            I am currently available to take on new projects, so feel free about
            anything that you want me to work on. You can contact anytime.{" "}
          </p>
          <div className="contact-details">
            <div className="contact-detail">
              <img src={mail_icon} alt="image" />
              <p>shaidabmansoori2001@gmail.com</p>
            </div>
            <div className="contact-detail">
